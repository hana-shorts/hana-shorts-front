// src/components/StocksKosdaqPrice.js
  ...
  const fetchStocks = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8080/api/stockKosdaqPrice"
      );
      ...
      console.error("Error fetching KOSDAQ stock data:", error);
    } finally {
...
export default StocksKosdaqPrice;
